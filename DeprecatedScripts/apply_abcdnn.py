...
def fill_tree( sample, dLocal ):
  ...
  #print(sample)
  #print(config.sourceDir[ args.location ])
  ...
  for checkpoint in checkpoints:
    ...
    for variable in variables_transform[ checkpoint ]:
      #print(variables_transform[ checkpoint ])
  ...
  def loop_tree( rTree_in, rTree_out, i ):
    ...
    for checkpoint in checkpoints:
      ...
      #print("transfers[ checkpoint ]: {}".format(transfers[ checkpoint ]))
