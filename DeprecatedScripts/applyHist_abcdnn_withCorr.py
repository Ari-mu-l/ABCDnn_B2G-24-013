...
# pNet, trainUncert all wrt original
# Nominal: with correction
# withCorrect: wrt nominal (with CorrectDn: no correcrtion. with CorrectUp: twice correction)
histList = ["Original", "pNetUp", "pNetDn", "trainUncertUp", "trainUncertDn", "Nominal", "withCorrectDUp", "withCorrectDDn"]
